 ...
 * @author Anjana
 */
public class School_of_Bus extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "SELECT * FROM business_subject where year='"  +combo_year.getSelectedItem().toString()+ "' and semester_term='" +combo_sem.getSelectedItem().toString()+"' ";
        try{
           ...
           con  = MysqlConnect.ConnectDB();
        String sql = "SELECT * FROM Master_business_subject where year='"  +combo_year.getSelectedItem().toString()+ "' and semester_term='" +combo_sem.getSelectedItem().toString()+"' ";
        try{
            st = con.prepareStatement(sql);
            rs = st.executeQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(School_of_Bus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
